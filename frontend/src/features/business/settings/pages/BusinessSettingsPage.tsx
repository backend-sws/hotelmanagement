          ...
          <div className="lg:col-span-12 min-w-0 flex flex-col gap-4">
            ...
            <div className="relative bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl p-6 sm:p-8 md:p-10 rounded-3xl border border-slate-200/80 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] min-w-0 flex flex-col gap-8 overflow-hidden">
              ...
              <div className="relative z-10 w-full space-y-6">
                <div className={activeTab !== 'locations' && activeTab !== 'gst' && activeTab !== 'plan' && activeTab !== 'invoice_design' ? 'block' : 'hidden'}>
                  <DynamicForm 
                    id="settings-form"
                    form={form}
                    onSubmit={onSubmit}
                ...
                <div className={activeTab !== 'locations' && activeTab !== 'gst' && activeTab !== 'plan' && activeTab !== 'invoice_design' ? 'flex justify-end mt-4 pt-6 border-t border-slate-200/80 dark:border-white/10' : 'hidden'}>
                  <Button 
                    type="submit" 
                    form="settings-form" 
